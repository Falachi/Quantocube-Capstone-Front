...
const DraftQuotationScreen = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.statusSection}>
          <View style={styles.statusItem}>
            ...
            <View style={styles.statusDetails}>
              <Text style={styles.statusText}>New Requested</Text>
          ...
          <View style={styles.statusItem}>
            <Image source={{ uri: 'https://via.placeholder.com/50' }} style={[styles.icon, { backgroundColor: '#F7B32B' }]} />
            <View style={styles.statusDetails}>
              <Text style={styles.statusText}>Draft Quotation</Text>
              <Text style={styles.statusDate}>22 Jun</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.serviceRequestSection}>
          <Text style={styles.serviceRequestTitle}>Quotation</Text>
          <TouchableOpacity style={styles.previewButton}>
            <Text style={styles.previewText}>Preview</Text>
          </TouchableOpacity>
          <Text style={styles.requestDateTitle}>Sent on</Text>
          <Text style={styles.requestDate}>Not Yet</Text>
        </View>
...
export default DraftQuotationScreen;
