...
const ServiceApproved = ({ navigation }) => {
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.card}>
        <View style={styles.cardHeader}>
          <Text style={styles.cardTitle}>Service Approved</Text>
          <Text style={styles.cardStatus}>Approved</Text>
        </View>
...
export default ServiceApproved;
